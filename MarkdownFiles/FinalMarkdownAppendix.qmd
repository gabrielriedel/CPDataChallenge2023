...
This code set uses the functions from above to track the movement of base runners on bunts. The function draws points on a field of where the base runners are before the bunt, and then shows the location the fielder picked up the bunt as well as where the runners moved to after the bunt play.
